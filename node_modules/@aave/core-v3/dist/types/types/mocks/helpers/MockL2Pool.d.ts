...
export interface MockL2PoolInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "ADDRESSES_PROVIDER" | "BRIDGE_PROTOCOL_FEE" | "FLASHLOAN_PREMIUM_TOTAL" | "FLASHLOAN_PREMIUM_TO_PROTOCOL" | "MAX_NUMBER_RESERVES" | "MAX_STABLE_RATE_BORROW_SIZE_PERCENT" | "POOL_REVISION" | "backUnbacked" | "borrow(address,uint256,uint256,uint16,address)" | "borrow(bytes32)" | "configureEModeCategory" | "deposit" | "dropReserve" | "finalizeTransfer" | "flashLoan" | "flashLoanSimple" | "getConfiguration" | "getEModeCategoryData" | "getReserveAddressById" | "getReserveData" | "getReserveNormalizedIncome" | "getReserveNormalizedVariableDebt" | "getReservesList" | "getUserAccountData" | "getUserConfiguration" | "getUserEMode" | "initReserve" | "initialize" | "liquidationCall(address,address,address,uint256,bool)" | "liquidationCall(bytes32,bytes32)" | "mintToTreasury" | "mintUnbacked" | "rebalanceStableBorrowRate(bytes32)" | "rebalanceStableBorrowRate(address,address)" | "repay(bytes32)" | "repay(address,uint256,uint256,address)" | "repayWithATokens(address,uint256,uint256)" | "repayWithATokens(bytes32)" | "repayWithPermit(bytes32,bytes32,bytes32)" | "repayWithPermit(address,uint256,uint256,address,uint256,uint8,bytes32,bytes32)" | "rescueTokens" | "resetIsolationModeTotalDebt" | "setConfiguration" | "setReserveInterestRateStrategyAddress" | "setUserEMode" | "setUserUseReserveAsCollateral(bytes32)" | "setUserUseReserveAsCollateral(address,bool)" | "supply(address,uint256,address,uint16)" | "supply(bytes32)" | "supplyWithPermit(address,uint256,address,uint16,uint256,uint8,bytes32,bytes32)" | "supplyWithPermit(bytes32,bytes32,bytes32)" | "swapBorrowRateMode(bytes32)" | "swapBorrowRateMode(address,uint256)" | "updateBridgeProtocolFee" | "updateFlashloanPremiums" | "withdraw(address,uint256,address)" | "withdraw(bytes32)"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "borrow(address,uint256,uint256,uint16,address)", values: [
        PromiseOrValue<string>,
        PromiseOrValue<BigNumberish>,
        PromiseOrValue<BigNumberish>,
        PromiseOrValue<BigNumberish>,
    ...
    encodeFunctionData(functionFragment: "borrow(bytes32)", values: [PromiseOrValue<BytesLike>]): string;
    ...
    encodeFunctionData(functionFragment: "liquidationCall(address,address,address,uint256,bool)", values: [
        PromiseOrValue<string>,
        PromiseOrValue<string>,
        PromiseOrValue<string>,
        PromiseOrValue<BigNumberish>,
    ...
    encodeFunctionData(functionFragment: "liquidationCall(bytes32,bytes32)", values: [PromiseOrValue<BytesLike>, PromiseOrValue<BytesLike>]): string;
    ...
    encodeFunctionData(functionFragment: "rebalanceStableBorrowRate(bytes32)", values: [PromiseOrValue<BytesLike>]): string;
    encodeFunctionData(functionFragment: "rebalanceStableBorrowRate(address,address)", values: [PromiseOrValue<string>, PromiseOrValue<string>]): string;
    encodeFunctionData(functionFragment: "repay(bytes32)", values: [PromiseOrValue<BytesLike>]): string;
    encodeFunctionData(functionFragment: "repay(address,uint256,uint256,address)", values: [
        PromiseOrValue<string>,
        PromiseOrValue<BigNumberish>,
        PromiseOrValue<BigNumberish>,
        PromiseOrValue<string>
    ]): string;
    encodeFunctionData(functionFragment: "repayWithATokens(address,uint256,uint256)", values: [
        PromiseOrValue<string>,
        PromiseOrValue<BigNumberish>,
        PromiseOrValue<BigNumberish>
    ]): string;
    encodeFunctionData(functionFragment: "repayWithATokens(bytes32)", values: [PromiseOrValue<BytesLike>]): string;
    encodeFunctionData(functionFragment: "repayWithPermit(bytes32,bytes32,bytes32)", values: [
        PromiseOrValue<BytesLike>,
        PromiseOrValue<BytesLike>,
        PromiseOrValue<BytesLike>
    ]): string;
    encodeFunctionData(functionFragment: "repayWithPermit(address,uint256,uint256,address,uint256,uint8,bytes32,bytes32)", values: [
        PromiseOrValue<string>,
        PromiseOrValue<BigNumberish>,
        PromiseOrValue<BigNumberish>,
        PromiseOrValue<string>,
    ...
    encodeFunctionData(functionFragment: "setUserUseReserveAsCollateral(bytes32)", values: [PromiseOrValue<BytesLike>]): string;
    encodeFunctionData(functionFragment: "setUserUseReserveAsCollateral(address,bool)", values: [PromiseOrValue<string>, PromiseOrValue<boolean>]): string;
    encodeFunctionData(functionFragment: "supply(address,uint256,address,uint16)", values: [
        PromiseOrValue<string>,
        PromiseOrValue<BigNumberish>,
        PromiseOrValue<string>,
        PromiseOrValue<BigNumberish>
    ]): string;
    encodeFunctionData(functionFragment: "supply(bytes32)", values: [PromiseOrValue<BytesLike>]): string;
    encodeFunctionData(functionFragment: "supplyWithPermit(address,uint256,address,uint16,uint256,uint8,bytes32,bytes32)", values: [
        PromiseOrValue<string>,
        PromiseOrValue<BigNumberish>,
        PromiseOrValue<string>,
        PromiseOrValue<BigNumberish>,
    ...
    encodeFunctionData(functionFragment: "supplyWithPermit(bytes32,bytes32,bytes32)", values: [
        PromiseOrValue<BytesLike>,
        PromiseOrValue<BytesLike>,
        PromiseOrValue<BytesLike>
    ]): string;
    encodeFunctionData(functionFragment: "swapBorrowRateMode(bytes32)", values: [PromiseOrValue<BytesLike>]): string;
    encodeFunctionData(functionFragment: "swapBorrowRateMode(address,uint256)", values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]): string;
    ...
    encodeFunctionData(functionFragment: "withdraw(address,uint256,address)", values: [
        PromiseOrValue<string>,
        PromiseOrValue<BigNumberish>,
        PromiseOrValue<string>
    ]): string;
    encodeFunctionData(functionFragment: "withdraw(bytes32)", values: [PromiseOrValue<BytesLike>]): string;
    ...
    decodeFunctionResult(functionFragment: "borrow(address,uint256,uint256,uint16,address)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "liquidationCall(address,address,address,uint256,bool)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "liquidationCall(bytes32,bytes32)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "rebalanceStableBorrowRate(bytes32)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "rebalanceStableBorrowRate(address,address)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "repay(bytes32)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "repay(address,uint256,uint256,address)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "repayWithATokens(address,uint256,uint256)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "repayWithATokens(bytes32)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "repayWithPermit(bytes32,bytes32,bytes32)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "repayWithPermit(address,uint256,uint256,address,uint256,uint8,bytes32,bytes32)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "setUserUseReserveAsCollateral(bytes32)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setUserUseReserveAsCollateral(address,bool)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "supply(address,uint256,address,uint16)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "supply(bytes32)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "supplyWithPermit(address,uint256,address,uint16,uint256,uint8,bytes32,bytes32)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "supplyWithPermit(bytes32,bytes32,bytes32)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "swapBorrowRateMode(bytes32)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "swapBorrowRateMode(address,uint256)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "withdraw(address,uint256,address)", data: BytesLike): Result;
...
export interface MockL2Pool extends BaseContract {
    ...
    functions: {
        ...
        "borrow(address,uint256,uint256,uint16,address)"(asset: PromiseOrValue<string>, amount: PromiseOrValue<BigNumberish>, interestRateMode: PromiseOrValue<BigNumberish>, referralCode: PromiseOrValue<BigNumberish>, onBehalfOf: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        "borrow(bytes32)"(args: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        "liquidationCall(address,address,address,uint256,bool)"(collateralAsset: PromiseOrValue<string>, debtAsset: PromiseOrValue<string>, user: PromiseOrValue<string>, debtToCover: PromiseOrValue<BigNumberish>, receiveAToken: PromiseOrValue<boolean>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        "liquidationCall(bytes32,bytes32)"(args1: PromiseOrValue<BytesLike>, args2: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        "rebalanceStableBorrowRate(bytes32)"(args: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        "rebalanceStableBorrowRate(address,address)"(asset: PromiseOrValue<string>, user: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        "repay(bytes32)"(args: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        "repay(address,uint256,uint256,address)"(asset: PromiseOrValue<string>, amount: PromiseOrValue<BigNumberish>, interestRateMode: PromiseOrValue<BigNumberish>, onBehalfOf: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        "repayWithATokens(address,uint256,uint256)"(asset: PromiseOrValue<string>, amount: PromiseOrValue<BigNumberish>, interestRateMode: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        "repayWithATokens(bytes32)"(args: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        "repayWithPermit(bytes32,bytes32,bytes32)"(args: PromiseOrValue<BytesLike>, r: PromiseOrValue<BytesLike>, s: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        "repayWithPermit(address,uint256,uint256,address,uint256,uint8,bytes32,bytes32)"(asset: PromiseOrValue<string>, amount: PromiseOrValue<BigNumberish>, interestRateMode: PromiseOrValue<BigNumberish>, onBehalfOf: PromiseOrValue<string>, deadline: PromiseOrValue<BigNumberish>, permitV: PromiseOrValue<BigNumberish>, permitR: PromiseOrValue<BytesLike>, permitS: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        "setUserUseReserveAsCollateral(bytes32)"(args: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        "setUserUseReserveAsCollateral(address,bool)"(asset: PromiseOrValue<string>, useAsCollateral: PromiseOrValue<boolean>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        "supply(address,uint256,address,uint16)"(asset: PromiseOrValue<string>, amount: PromiseOrValue<BigNumberish>, onBehalfOf: PromiseOrValue<string>, referralCode: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        "supply(bytes32)"(args: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        "supplyWithPermit(bytes32,bytes32,bytes32)"(args: PromiseOrValue<BytesLike>, r: PromiseOrValue<BytesLike>, s: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        "swapBorrowRateMode(bytes32)"(args: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        "swapBorrowRateMode(address,uint256)"(asset: PromiseOrValue<string>, interestRateMode: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        "withdraw(address,uint256,address)"(asset: PromiseOrValue<string>, amount: PromiseOrValue<BigNumberish>, to: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        "withdraw(bytes32)"(args: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    ADDRESSES_PROVIDER(overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        ...
        "borrow(address,uint256,uint256,uint16,address)"(asset: PromiseOrValue<string>, amount: PromiseOrValue<BigNumberish>, interestRateMode: PromiseOrValue<BigNumberish>, referralCode: PromiseOrValue<BigNumberish>, onBehalfOf: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        ...
        "liquidationCall(address,address,address,uint256,bool)"(collateralAsset: PromiseOrValue<string>, debtAsset: PromiseOrValue<string>, user: PromiseOrValue<string>, debtToCover: PromiseOrValue<BigNumberish>, receiveAToken: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<void>;
        "liquidationCall(bytes32,bytes32)"(args1: PromiseOrValue<BytesLike>, args2: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
        ...
        "rebalanceStableBorrowRate(bytes32)"(args: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
        "rebalanceStableBorrowRate(address,address)"(asset: PromiseOrValue<string>, user: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        "repay(bytes32)"(args: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<BigNumber>;
        "repay(address,uint256,uint256,address)"(asset: PromiseOrValue<string>, amount: PromiseOrValue<BigNumberish>, interestRateMode: PromiseOrValue<BigNumberish>, onBehalfOf: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        "repayWithATokens(address,uint256,uint256)"(asset: PromiseOrValue<string>, amount: PromiseOrValue<BigNumberish>, interestRateMode: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        "repayWithATokens(bytes32)"(args: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<BigNumber>;
        "repayWithPermit(bytes32,bytes32,bytes32)"(args: PromiseOrValue<BytesLike>, r: PromiseOrValue<BytesLike>, s: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        "setUserUseReserveAsCollateral(bytes32)"(args: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
        "setUserUseReserveAsCollateral(address,bool)"(asset: PromiseOrValue<string>, useAsCollateral: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<void>;
        "supply(address,uint256,address,uint16)"(asset: PromiseOrValue<string>, amount: PromiseOrValue<BigNumberish>, onBehalfOf: PromiseOrValue<string>, referralCode: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        ...
        "supplyWithPermit(bytes32,bytes32,bytes32)"(args: PromiseOrValue<BytesLike>, r: PromiseOrValue<BytesLike>, s: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
        "swapBorrowRateMode(bytes32)"(args: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
        "swapBorrowRateMode(address,uint256)"(asset: PromiseOrValue<string>, interestRateMode: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        ...
        "withdraw(address,uint256,address)"(asset: PromiseOrValue<string>, amount: PromiseOrValue<BigNumberish>, to: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        "withdraw(bytes32)"(args: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
...
//# sourceMappingURL=MockL2Pool.d.ts.map