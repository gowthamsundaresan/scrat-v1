...
export interface ValidationLogicInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "HEALTH_FACTOR_LIQUIDATION_THRESHOLD" | "MINIMUM_HEALTH_FACTOR_LIQUIDATION_THRESHOLD" | "REBALANCE_UP_LIQUIDITY_RATE_THRESHOLD"): FunctionFragment;
