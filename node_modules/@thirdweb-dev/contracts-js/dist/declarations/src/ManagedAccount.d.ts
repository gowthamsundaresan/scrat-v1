...
export interface ManagedAccountInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "DEFAULT_ADMIN_ROLE" | "SIGNER_ROLE" | "addDeposit" | "entryPoint" | "factory" | "getDeposit" | "getImplementationForFunction" | "getNonce" | "initialize" | "isValidSigner" | "multicall" | "validateUserOp" | "withdrawDepositTo"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "isValidSigner", values: [string]): string;
...
export interface ManagedAccount extends BaseContract {
    ...
    functions: {
        ...
        isValidSigner(_signer: string, overrides?: CallOverrides): Promise<[boolean]>;
    ...
    estimateGas: {
        ...
        isValidSigner(_signer: string, overrides?: CallOverrides): Promise<BigNumber>;
        multicall(data: BytesLike[], overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<BigNumber>;
        validateUserOp(userOp: UserOperationStruct, userOpHash: BytesLike, missingAccountFunds: BigNumberish, overrides?: Overrides & {
    ...
    populateTransaction: {
        ...
        isValidSigner(_signer: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        multicall(data: BytesLike[], overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<PopulatedTransaction>;
        validateUserOp(userOp: UserOperationStruct, userOpHash: BytesLike, missingAccountFunds: BigNumberish, overrides?: Overrides & {
