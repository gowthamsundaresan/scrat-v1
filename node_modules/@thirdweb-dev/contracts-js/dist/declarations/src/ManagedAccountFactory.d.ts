...
export interface ManagedAccountFactoryInterface extends utils.Interface {
    functions: {
        ...
        "defaultExtension()": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "DEFAULT_ADMIN_ROLE" | "accountImplementation" | "addExtension" | "addSigner" | "createAccount" | "defaultExtension" | "getAccountsOfSigner" | "getAddress" | "getAllExtensions" | "getAllFunctionsOfExtension" | "getExtension" | "getExtensionForFunction" | "getExtensionImplementation" | "getImplementationForFunction" | "getRoleAdmin" | "getRoleMember" | "getRoleMemberCount" | "getSignersOfAccount" | "grantRole" | "hasRole" | "hasRoleWithSwitch" | "multicall" | "removeExtension" | "removeSigner" | "renounceRole" | "revokeRole" | "supportsInterface" | "updateExtension"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "defaultExtension", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "defaultExtension", data: BytesLike): Result;
...
export interface ManagedAccountFactory extends BaseContract {
    ...
    functions: {
        ...
        addSigner(_signer: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        createAccount(_admin: string, _data: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        defaultExtension(overrides?: CallOverrides): Promise<[string]>;
        getAccountsOfSigner(signer: string, overrides?: CallOverrides): Promise<[string[]] & {
            accounts: string[];
        }>;
        getAddress(_adminSigner: string, overrides?: CallOverrides): Promise<[string]>;
    ...
    estimateGas: {
        ...
        defaultExtension(overrides?: CallOverrides): Promise<BigNumber>;
        getAccountsOfSigner(signer: string, overrides?: CallOverrides): Promise<BigNumber>;
        getAddress(_adminSigner: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        defaultExtension(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getAccountsOfSigner(signer: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getAddress(_adminSigner: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
