...
class Edition extends erc1155Standard.StandardErc1155 {
  ...
  constructor(network, address, storage) {
     ...
     */
    QueryParams._defineProperty(this, "mint", custom.buildTransactionFunction(async metadataWithSupply => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "mintTo", custom.buildTransactionFunction(async (to, metadataWithSupply) => {
     ...
     */
    QueryParams._defineProperty(this, "mintAdditionalSupply", custom.buildTransactionFunction(async (tokenId, additionalSupply) => {
     ...
     * @param additionalSupply - the additional amount to mint
     */
    QueryParams._defineProperty(this, "mintAdditionalSupplyTo", custom.buildTransactionFunction(async (to, tokenId, additionalSupply) => {
     ...
     */
    QueryParams._defineProperty(this, "mintBatch", custom.buildTransactionFunction(async metadatas => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "mintBatchTo", custom.buildTransactionFunction(async (to, metadataWithSupply) => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "burn", custom.buildTransactionFunction(async (tokenId, amount) => {
      return this.erc1155.burn.prepare(tokenId, amount);
    }));
    this.abi = custom.AbiSchema.parse(abi || []);
    this.metadata = new custom.ContractMetadata(this.contractWrapper, custom.TokenErc1155ContractSchema, this.storage);
    this.app = new custom.ContractAppURI(this.contractWrapper, this.metadata, this.storage);
    this.roles = new custom.ContractRoles(this.contractWrapper, Edition.contractRoles);
    ...
    this.signature = new custom.Erc1155SignatureMintable(this.contractWrapper, this.storage, this.roles);
