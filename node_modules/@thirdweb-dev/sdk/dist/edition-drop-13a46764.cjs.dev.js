...
class EditionDrop extends erc1155Standard.StandardErc1155 {
  ...
  constructor(network, _address, storage) {
    ...
    let contractWrapper = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : new custom.ContractWrapper(network, _address, abi, _options);
     ...
     */
    QueryParams._defineProperty(this, "claimTo", custom.buildTransactionFunction(async function (destinationAddress, tokenId, quantity) {
     ...
     * @returns - Receipt for the transaction
     */
    QueryParams._defineProperty(this, "claim", custom.buildTransactionFunction(async function (tokenId, quantity) {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "burnTokens", custom.buildTransactionFunction(async (tokenId, amount) => {
      return this.erc1155.burn.prepare(tokenId, amount);
    }));
    this.abi = custom.AbiSchema.parse(abi);
    this.metadata = new custom.ContractMetadata(this.contractWrapper, custom.DropErc1155ContractSchema, this.storage);
    this.app = new custom.ContractAppURI(this.contractWrapper, this.metadata, this.storage);
    this.roles = new custom.ContractRoles(this.contractWrapper, EditionDrop.contractRoles);
    ...
    this.claimConditions = new custom.DropErc1155ClaimConditions(this.contractWrapper, this.metadata, this.storage);
