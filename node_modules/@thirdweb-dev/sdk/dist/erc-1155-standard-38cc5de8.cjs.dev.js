...
class StandardErc1155 {
  ...
  constructor(contractWrapper, storage, chainId) {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "transfer", custom.buildTransactionFunction(async function (to, tokenId, amount) {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "airdrop", custom.buildTransactionFunction(async function (tokenId, addresses) {
    ...
    this.erc1155 = new custom.Erc1155(this.contractWrapper, this.storage, chainId);
