...
class StandardErc20 {
  ...
  constructor(contractWrapper, storage, chainId) {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "transfer", custom.buildTransactionFunction(async (to, amount) => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "transferFrom", custom.buildTransactionFunction(async (from, to, amount) => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "setAllowance", custom.buildTransactionFunction(async (spender, amount) => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "transferBatch", custom.buildTransactionFunction(async args => {
      return this.erc20.transferBatch.prepare(args);
    }));
    this.contractWrapper = contractWrapper;
    this.storage = storage;
    this.erc20 = new custom.Erc20(this.contractWrapper, this.storage, chainId);
