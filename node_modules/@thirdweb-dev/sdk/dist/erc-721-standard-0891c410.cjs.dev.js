...
class StandardErc721 {
  ...
  constructor(contractWrapper, storage, chainId) {
    ...
    QueryParams._defineProperty(this, "setApprovalForToken", custom.buildTransactionFunction(async (operator, tokenId) => {
      return custom.Transaction.fromContractWrapper({
        ...
        method: "approve",
        args: [await custom.resolveAddress(operator), tokenId]
      });
    }));
    this.contractWrapper = contractWrapper;
    this.storage = storage;
    this.erc721 = new custom.Erc721(this.contractWrapper, this.storage, chainId);
  ...
  async getOwned(walletAddress) {
    if (walletAddress) {
      walletAddress = await custom.resolveAddress(walletAddress);
    }
