...
class MarketplaceV3 {
   ...
   */
  get directListings() {
    return custom.assertEnabled(this.detectDirectListings(), custom.FEATURE_DIRECT_LISTINGS);
  }
  /**
   * Auctions
   ...
   */
  get englishAuctions() {
    return custom.assertEnabled(this.detectEnglishAuctions(), custom.FEATURE_ENGLISH_AUCTIONS);
  }
   ...
   */
  get offers() {
    return custom.assertEnabled(this.detectOffers(), custom.FEATURE_OFFERS);
  }
  get chainId() {
  ...
  constructor(network, address, storage) {
    ...
    this.roles = new custom.ContractRoles(this.contractWrapper, MarketplaceV3.contractRoles);
  ...
  detectDirectListings() {
    if (custom.detectContractFeature(this.contractWrapper, "DirectListings")) {
      return new custom.MarketplaceV3DirectListings(this.contractWrapper, this.storage);
    }
    return undefined;
  }
  detectEnglishAuctions() {
    if (custom.detectContractFeature(this.contractWrapper, "EnglishAuctions")) {
      return new custom.MarketplaceV3EnglishAuctions(this.contractWrapper, this.storage);
    }
    return undefined;
  }
  detectOffers() {
    if (custom.detectContractFeature(this.contractWrapper, "Offers")) {
      return new custom.MarketplaceV3Offers(this.contractWrapper, this.storage);
    }
    return undefined;
  }
}
