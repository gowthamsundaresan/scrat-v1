...
class NFTCollection extends erc721Standard.StandardErc721 {
  ...
  constructor(network, address, storage) {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "mint", custom.buildTransactionFunction(async metadata => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "mintTo", custom.buildTransactionFunction(async (walletAddress, metadata) => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "mintBatch", custom.buildTransactionFunction(async metadata => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "mintBatchTo", custom.buildTransactionFunction(async (walletAddress, metadata) => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "burn", custom.buildTransactionFunction(tokenId => {
      return this.erc721.burn.prepare(tokenId);
    }));
    this.abi = custom.AbiSchema.parse(abi || []);
    this.metadata = new custom.ContractMetadata(this.contractWrapper, custom.TokenErc721ContractSchema, this.storage);
    this.app = new custom.ContractAppURI(this.contractWrapper, this.metadata, this.storage);
    this.roles = new custom.ContractRoles(this.contractWrapper, NFTCollection.contractRoles);
