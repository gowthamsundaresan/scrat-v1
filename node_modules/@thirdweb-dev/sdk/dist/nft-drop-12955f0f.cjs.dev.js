...
var erc721Standard = require('./erc-721-standard-0891c410.cjs.dev.js');
var thirdwebCheckout = require('./thirdweb-checkout-1bc7ba37.cjs.dev.js');
...
class NFTDrop extends erc721Standard.StandardErc721 {
  ...
  constructor(network, address, storage) {
    ...
    let contractWrapper = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : new custom.ContractWrapper(network, address, abi, _options);
     ...
     */
    QueryParams._defineProperty(this, "createBatch", custom.buildTransactionFunction(async (metadatas, options) => {
     ...
     */
    QueryParams._defineProperty(this, "claimTo", custom.buildTransactionFunction(async function (destinationAddress, quantity) {
     ...
     * @returns - an array of results containing the id of the token claimed, the transaction receipt and a promise to optionally fetch the nft metadata
     */
    QueryParams._defineProperty(this, "claim", custom.buildTransactionFunction(async function (quantity) {
     ...
     *
     */
    QueryParams._defineProperty(this, "burn", custom.buildTransactionFunction(async tokenId => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "transfer", custom.buildTransactionFunction(async (to, tokenId) => {
     ...
     * @internal
     */
    QueryParams._defineProperty(this, "setApprovalForAll", custom.buildTransactionFunction(async (operator, approved) => {
     ...
     * @internal
     */
    QueryParams._defineProperty(this, "setApprovalForToken", custom.buildTransactionFunction(async (operator, tokenId) => {
    ...
    this.metadata = new custom.ContractMetadata(this.contractWrapper, custom.DropErc721ContractSchema, this.storage);
    this.app = new custom.ContractAppURI(this.contractWrapper, this.metadata, this.storage);
    this.roles = new custom.ContractRoles(this.contractWrapper, NFTDrop.contractRoles);
    this.royalties = new custom.ContractRoyalty(this.contractWrapper, this.metadata);
    this.sales = new custom.ContractPrimarySale(this.contractWrapper);
    this.claimConditions = new custom.DropClaimConditions(this.contractWrapper, this.metadata, this.storage);
    ...
    this.revealer = new custom.DelayedReveal(this.contractWrapper, this.storage, custom.FEATURE_NFT_REVEALABLE.name, () => this.erc721.nextTokenIdToMint());
  ...
  async isTransferRestricted() {
    const anyoneCanTransfer = await this.contractWrapper.readContract.hasRole(custom.getRoleHash("transfer"), ethers.constants.AddressZero);
