...
class SignatureDrop extends erc721Standard.StandardErc721 {
  ...
  constructor(network, address, storage) {
     ...
     */
    QueryParams._defineProperty(this, "claimTo", custom.buildTransactionFunction(async (destinationAddress, quantity, options) => {
     ...
     * @returns - an array of results containing the id of the token claimed, the transaction receipt and a promise to optionally fetch the nft metadata
     */
    QueryParams._defineProperty(this, "claim", custom.buildTransactionFunction(async (quantity, options) => {
    ...
    this.roles = new custom.ContractRoles(this.contractWrapper, SignatureDrop.contractRoles);
    ...
    this.signature = new custom.Erc721WithQuantitySignatureMintable(this.contractWrapper, this.storage);
