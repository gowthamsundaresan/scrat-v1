...
var erc20History = require('./erc-20-history-15cdc1e0.cjs.dev.js');
...
class Token extends erc20Standard.StandardErc20 {
  ...
  constructor(network, address, storage) {
     ...
     */
    QueryParams._defineProperty(this, "mint", custom.buildTransactionFunction(async amount => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "mintTo", custom.buildTransactionFunction(async (to, amount) => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "mintBatchTo", custom.buildTransactionFunction(async args => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "burn", custom.buildTransactionFunction(amount => {
    ...
    this.metadata = new custom.ContractMetadata(this.contractWrapper, custom.TokenErc20ContractSchema, this.storage);
    this.app = new custom.ContractAppURI(this.contractWrapper, this.metadata, this.storage);
    this.roles = new custom.ContractRoles(this.contractWrapper, Token.contractRoles);
    ...
    this.signature = new custom.Erc20SignatureMintable(this.contractWrapper, this.roles);
  }
