...
var erc20Standard = require('./erc-20-standard-828146ec.cjs.dev.js');
...
class TokenDrop extends erc20Standard.StandardErc20 {
  ...
  constructor(network, address, storage) {
     ...
     */
    QueryParams._defineProperty(this, "claim", custom.buildTransactionFunction(async function (amount) {
     ...
     */
    QueryParams._defineProperty(this, "claimTo", custom.buildTransactionFunction(async function (destinationAddress, amount) {
     ...
     * @alpha
     */
    QueryParams._defineProperty(this, "delegateTo", custom.buildTransactionFunction(async delegateeAddress => {
      return custom.Transaction.fromContractWrapper({
        contractWrapper: this.contractWrapper,
        method: "delegate",
        args: [await custom.resolveAddress(delegateeAddress)]
      });
    }));
    /**
     * Burn Tokens
     ...
     * ```
     */
    QueryParams._defineProperty(this, "burnTokens", custom.buildTransactionFunction(async amount => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "burnFrom", custom.buildTransactionFunction(async (holder, amount) => {
      return this.erc20.burnFrom.prepare(holder, amount);
    }));
    this.abi = custom.AbiSchema.parse(abi || []);
    this.metadata = new custom.ContractMetadata(this.contractWrapper, custom.DropErc20ContractSchema, this.storage);
    this.app = new custom.ContractAppURI(this.contractWrapper, this.metadata, this.storage);
    this.roles = new custom.ContractRoles(this.contractWrapper, TokenDrop.contractRoles);
  ...
  async getVoteBalanceOf(account) {
    return await this.erc20.getValue(await this.contractWrapper.readContract.getVotes(await custom.resolveAddress(account)));
  }
  ...
  async getDelegationOf(account) {
    return await this.contractWrapper.readContract.delegates(await custom.resolveAddress(account));
  }
